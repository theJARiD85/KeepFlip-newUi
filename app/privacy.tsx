...
const SECTIONS: LegalSection[] = [
  {
    ...
    body: [
      ...
      "Location is collected only when you grant permission and use a location-dependent feature. When you manually start an active sourcing trip, KeepFlip may use foreground or background location while you travel to calculate total business mileage. Tracking begins for that trip and stops when the trip is closed; KeepFlip stores the mileage total and related trip metadata, not a route history. Other location-aware features, such as nearby repair-provider research or approximate placement of a local marketplace listing, use location only when you request them.",
