...
const SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "KeepFlip may share limited information with RevenueCat and the applicable app store for subscription and purchase reconciliation; OpenAI for Flip and requested AI analysis; SerpApi for market research; Google Maps Platform for nearby repair-provider search; and support or infrastructure providers when needed to operate the requested feature.",
