...
function createResponsiveStyles(responsiveLayout: ReturnType<typeof useResponsiveLayout>) {
  ...
  const staticStyles = StyleSheet.create({
    ...
    backButton: { alignItems: 'center', borderColor: theme.colors.divider, borderRadius: 999, borderWidth: 1, flexDirection: 'row', gap: 3, minHeight: 34, paddingHorizontal: 11 },
    ...
    choiceCard: { alignItems: 'center', backgroundColor: theme.colors.cardSoft, borderColor: theme.colors.divider, borderRadius: 16, borderWidth: 1, flexDirection: 'row', gap: 11, minHeight: 50, padding: 11 },
    choiceCardSelected: { backgroundColor: theme.colors.iconSurfaceCyan, borderColor: theme.colors.accentCyanBorder },
    choiceCopy: { flex: 1, gap: 2 },
    choiceDetail: { color: theme.colors.textMuted, fontSize: (11), lineHeight: 15 },
    choiceIcon: { alignItems: 'center', backgroundColor: theme.colors.iconSurfaceGold, borderRadius: 12, height: 40, justifyContent: 'center', width: 40 },
    ...
    coinFace: { backgroundColor: theme.colors.surfaceInset, borderColor: theme.colors.accentGoldBorder, borderRadius: 999, borderWidth: 2, height: 110, overflow: 'hidden', width: 110 },
    ...
    featureIcon: { alignItems: 'center', backgroundColor: theme.colors.iconSurfaceCyan, borderRadius: 10, height: 33, justifyContent: 'center', width: 33 },
    ...
    messageBubble: { backgroundColor: theme.colors.iconSurfaceViolet, borderColor: theme.colors.accentVioletBorder, borderRadius: 16, borderTopLeftRadius: 5, borderWidth: 1, gap: 4, padding: 13 },
    ...
    nameBlock: { gap: 6 },
    nameInput: { backgroundColor: theme.colors.surfaceSoft, borderColor: theme.colors.dividerStrong, borderRadius: 12, borderWidth: 1, color: theme.colors.cream, fontSize: 15, minHeight: 52, paddingHorizontal: 14 },
    ...
    panel: { backgroundColor: theme.colors.card, borderColor: theme.colors.divider, justifyContent: 'space-evenly', borderRadius: 10, borderWidth: 1, gap: 10, padding: 12, height: 'auto', minHeight: 350, paddingBottom: 10 },
    ...
    primaryButtonText: { color: theme.colors.textOnAccent, fontFamily: theme.fonts.bold, fontSize: 11, letterSpacing: 0.65 },
    progressRail: { top: 20, flexDirection: 'row', gap: 6, marginHorizontal: 'auto', maxWidth: 560, width: '100%' },
    progressSegment: { backgroundColor: theme.colors.divider, borderRadius: 999, flex: 1, height: 3 },
    ...
    radio: { alignItems: 'center', borderColor: theme.colors.dividerStrong, borderRadius: 999, borderWidth: 1, height: 18, justifyContent: 'center', width: 18 },
    ...
    summaryCard: { backgroundColor: theme.colors.iconSurfaceCyan, borderColor: theme.colors.accentCyanBorder, borderRadius: 16, borderWidth: 1, gap: 5, padding: 14 },
