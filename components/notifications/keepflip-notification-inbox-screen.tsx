...
function createResponsiveStyles(responsiveLayout: ReturnType<typeof useResponsiveLayout>) {
  ...
  return StyleSheet.create({
    ...
    markAll: { alignSelf: 'flex-end', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 10, borderWidth: 1, borderColor: 'rgba(87, 225, 236, 0.35)' },
    ...
    emptyCard: { alignItems: 'center', justifyContent: 'center', gap: 8, minHeight: 180, padding: 24, borderRadius: 18, borderWidth: 1, borderColor: 'rgba(242, 211, 138, 0.16)', backgroundColor: theme.colors.surfaceSoft },
    ...
    notification: { flexDirection: 'row', alignItems: 'center', gap: 12, overflow: 'hidden', minHeight: 96, paddingRight: 14, borderRadius: 18, borderWidth: 1, borderColor: 'rgba(242, 211, 138, 0.14)', backgroundColor: 'rgba(20, 19, 24, 0.82)' },
    notificationUnread: { borderColor: 'rgba(87, 225, 236, 0.32)', backgroundColor: 'rgba(20, 32, 36, 0.86)' },
