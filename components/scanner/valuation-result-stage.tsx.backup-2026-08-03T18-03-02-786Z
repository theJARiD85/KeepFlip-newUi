...
const styles = StyleSheet.create({
  ...
  resultDock: { position: "absolute", alignSelf: "center", bottom: 0, gap: 8, paddingHorizontal: 12, paddingTop: 11, borderTopLeftRadius: theme.radii.large, borderTopRightRadius: theme.radii.large, borderWidth: 1, borderBottomWidth: 0, borderColor: "rgba(0, 255, 255, 0.24)", backgroundColor: theme.colors.backgroundDeep, experimental_backgroundImage: `radial-gradient(circle at 80% 0%, rgba(141, 114, 255, 0.12) 0%, transparent 42%), linear-gradient(to bottom, rgba(7, 20, 45, 0.98) 0%, rgba(3, 10, 25, 0.99) 100%)`, boxShadow: "0 -18px 52px rgba(0, 0, 0, 0.58), 0 0 26px rgba(0, 255, 255, 0.07)" },
  ...
  sheetHandle: {
    ...
    boxShadow: "0 0 10px rgba(0, 255, 255, 0.62)",
  },
  sheetHandleLabel: {
  ...
  tabRail: { height: 34, flexDirection: "row", gap: 6, padding: 3, borderWidth: 1, borderColor: "rgba(0, 255, 255, 0.12)", borderRadius: 5, backgroundColor: "rgba(0, 3, 11, 0.62)" },
