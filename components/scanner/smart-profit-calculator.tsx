    ...
    try {
      ...
      setSaveMessage(
        saved.recordedExpenseCount > 0
          ? `Numbers saved · ${saved.recordedExpenseCount} Books ${saved.recordedExpenseCount === 1 ? "entry" : "entries"
          } recorded.`
...
function createResponsiveStyles(responsiveLayout: ReturnType<typeof useResponsiveLayout>) {
  ...
  const staticStyles = StyleSheet.create({
    ...
    breakdownRow: { flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", gap: 6, paddingTop: 8, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: theme.colors.divider },
