...
const HOLOGRAPHIC_PROJECTION_STATE = {
  detail:
    "Locking the median valuation and packaging the strongest profit actions.",
  callouts: [],
  progress: 0.98,
  stage: "Finalizing valuation target",
  status: "analyzing",
  steps: [
    { label: "Secure the scan evidence", status: "complete" },
    { label: "Extract value drivers and condition", status: "complete" },
    { label: "Build the strongest market match", status: "complete" },
    { label: "Calibrate low, median, and high value", status: "complete" },
    { label: "Generate profit-maximizing actions", status: "active" },
  ],
  ...
  return (
    <View style={styles.root}>
      ...
      <AnalysisBiometricTarget
        ...
        callouts={
          displayedState.status === "analyzing"
            ? displayedState.callouts
            : undefined
        }
