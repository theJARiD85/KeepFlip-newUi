...
function createResponsiveStyles(responsiveLayout: ReturnType<typeof useResponsiveLayout>) {
  ...
  const staticStyles = StyleSheet.create({
    ...
    creditColumn: { borderLeftColor: theme.colors.divider, borderLeftWidth: 1 },
    ...
    metricValueGreen: { color: theme.colors.success },
    metricValueRed: { color: theme.colors.danger },
