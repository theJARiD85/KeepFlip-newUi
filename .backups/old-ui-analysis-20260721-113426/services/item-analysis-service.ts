...
const MAX_FUNCTION_RESPONSE_CHARACTERS = 1_000_000_000;
const EBAY_COMPS_LIMIT = 8;
const EBAY_POLL_INTERVAL_MS = 650;
const EBAY_RESEARCH_TIMEOUT_MS = 30_000;
const TOTAL_ANALYSIS_BUDGET_MS = 90_000;
const LOCAL_VISION_TIMEOUT_MS = 15_500;
const PRIMARY_ANALYSIS_MAX_MS = 25_000;
